...
CAVERNA_ACTIONS = AttrDict({
    ...
    'Sow_2_Wheat': "Sow 2 wheat",
    'Sow_2_Wheat_1_Pumpkin': "Sow 2 wheat and 1 pumpkin",
    'Sow_2_Wheat_2_Pumpkin': "Sow 2 wheat and 2 pumpkins",
...
# reference rule book page 10 under "The Breeding Phase"
...
# reference rule appendix pages A4 and A5
...
# reference rule appendix pages A3 through A5
# added "Unavailable" to represent buildings already taken from inventory
...
# reference rule book page 17 under "Rubies"
DWARF_TEXT = AttrDict({
    'Unarmed': "Unarmed Dwarf",
    'Weapon_Level': "Dwarf with Weapon Level"
})

# reference rule appendix page A1 under "The Expedition Loot Items"
EXPEDITION_REWARDS = AttrDict({
    ...
    'Sow': "Sow up to 2 Wheat and up to 2 Pumpkins",
...
# reference rule book appendix A2 under "Weapon Strength 14"
...
EXPEDITION_BREEDING_OPTIONS = AttrDict({
    ...
    'Pigs_Only': "Pigs only",
    'Cows_Only': "Cows only",
    'Sheep_And_Donkeys': "Sheep and Donkeys",
...
# reference rule book page 10 under "Which Rounds End With a Harvest"
HARVEST_OPTIONS = AttrDict({
    'Skip_Breeding_Phase': "Skip breeding phase",
    'Skip_Field_Phase': "Skip field phase"
})

# reference rule book pages 9 and 10 under "Harvest Time" and "Which Rounds End With a Harvest"
...
# reference rule book page 1 under "Wooden and acrylic playing pieces"
# everything except "starting player token", "stables", and "dwarf discs"
# begging, food, and gold from reference rule book page 1 under "On counter sheets"
...
# reference rule appendix page A4 under "Block of 12 #2"
...
# reference rule book page 1 under "Furnishing and landscape tiles"
...
TILE_TYPES = AttrDict({
    ...
    'Wheat_Field_2': "Field with 2 wheat",
    'Wheat_Field_3': "Field with 3 wheat"
})
...
# reference rule book page 20 under "Rules on Animal Husbandry"
ANIMAL_TILE_TYPES = [
    TILE_TYPES.Stable,
    TILE_TYPES.Meadow,
    TILE_TYPES.Pasture_Small,
