...
ACTION_SPACE_TYPES = AttrDict({
    'Adventure_1-7_stage_4' : "adventure",
    'Blacksmithing_1-7_stage_1' : "blacksmithing",
    ...
    'Sustenance_1-3' : "sustenance for 1 to 3 players",
    'Sustenance_4-7' : "sustenance for 4 to 7 players",
